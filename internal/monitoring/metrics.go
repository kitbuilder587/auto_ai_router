...
var (
	...
	SpendSinkHealthy = promauto.NewGauge(
		prometheus.GaugeOpts{
			...
			Help: "Whether the authoritative spend sink passed startup guard and is healthy (1=yes)",
		},
	)
	...
	SpendSinkStartupFailuresTotal = promauto.NewCounterVec(
		prometheus.CounterOpts{
			...
			Help: "Critical spend sink startup failures that prevent proxy startup",
		},
		[]string{"reason"},
	)
