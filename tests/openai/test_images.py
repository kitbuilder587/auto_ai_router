"""
OpenAI image generation and editing tests.
Tests gpt-image-* models for text-to-image generation and image editing.
"""
...
class TestOpenAIImageGeneration:
    ...
    @pytest.mark.parametrize("model", TestModels.IMAGE_MODELS)
    ...
    @pytest.mark.parametrize("model", TestModels.IMAGE_MODELS)
    def test_response_structure(self, openai_client, model):
...
class TestOpenAIImageEdit:
    """Image editing with OpenAI image models (single image + prompt)."""
...
class TestOpenAIImageEditMulti:
