...
const (
	contractVersion = "air-shadow-spend/v1"
	liteLLMCommit   = "10d5804b3ef4ead5abb77c3f5fafdd0c0159de0f"
	goldenDirectory = "../../testdata/golden/shadow-spend"
)
...
type spendMetadata struct {
	...
	SpendLogsMetadata      shadowSpendExtensions `json:"spend_logs_metadata"`
}
...
type shadowSpendExtensions struct {
